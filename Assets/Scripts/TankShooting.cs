...
namespace Assets.Scripts
{
    public class TankShooting : MonoBehaviour
    {
        ...
        public void Fire()
        {
            ...
            GameObject bulletObject = GameObject.Instantiate(Bullet.gameObject); //ObjectPoolManager.Instance.SpawnObject(Bullet.gameObject);
            bulletObject.transform.position = FireBarrelTransform.position;
            bulletObject.transform.rotation = FireBarrelTransform.rotation;
            bulletObject.GetComponent<Bullet>().PlayerFrom = this.gameObject;
